...
| 18 | org-tree-slide-started                     | nil           | time    |
| 19 | org-tree-slide-presentation-length         | nil           | Numeric |
...
#+end_src
 ...
 If you want to display a timer of remaining time of the current slide,
 put this line at the end of your presentation org mode file (e.g. for
 30 min in total):
...
#+BEGIN_SRC emacs-lisp
       # eval: (setq org-show-notification-handler #'(lambda (msg) (message "time is up")))
#+END_SRC
...
** Remaining time display options
  ...
  - org-tree-slide-presentation-length
